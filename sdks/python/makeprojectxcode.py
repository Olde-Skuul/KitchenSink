...
class PBXBuildFile:
	...
	def write(self,fp):
		...
		if self.filereference.type == 'frameworks':
			type = 'Frameworks'
		else:
		# It's a source file
			type = 'Sources'
...
=======
	...
	if len(selfarray)!=0:
		...
		# Using the name of the class, output the array of data items
		itemname = selfarray[0].__class__.__name__
		fp.write('/* Begin ' + itemname + ' section */\n')
		for item in selfarray:
			item.write(fp)
		fp.write('/* End ' + itemname + ' section */\n\n')
>>>>>>> 8cfb6bc... Updated makeprojects to auto-generate iOS projects under XCode 5.x. iOS binaries are "fat", meaning they have armv7, armv7s, arm64, i386 and x86_64 binaries so it works both on a native device and on the simulators
...
<<<<<<< HEAD
		...
		if self.type != 'lib' and \
			self.type != 'exe' and \
			self.type != 'frameworks':
...
=======
		if self.type == 'lib':
			fp.write('\t\t' + self.uuid + ' /* ' + basename + ' */ = {isa = PBXFileReference; explicitFileType = archive.ar; includeInIndex = 0; path = ' + basename + '; sourceTree = BUILT_PRODUCTS_DIR; };\n')
		elif self.type == 'exe':
			fp.write('\t\t' + self.uuid + ' /* ' + basename + ' */ = {isa = PBXFileReference; explicitFileType = "compiled.mach-o.executable"; includeInIndex = 0; path = ' + basename + '; sourceTree = BUILT_PRODUCTS_DIR; };\n')
		elif self.type == 'frameworks':
			fp.write('\t\t' + self.uuid + ' /* ' + basename + ' */ = {isa = PBXFileReference; lastKnownFileType = wrapper.framework; name = ' + basename + '; path = System/Library/Frameworks/' + basename + '; sourceTree = SDKROOT; };\n')
		elif self.type == 'text.xcconfig':
			fp.write('\t\t' + self.uuid + ' /* ' + basename + ' */ = {isa = PBXFileReference; fileEncoding = 4; lastKnownFileType = text.xcconfig; name = ' + basename + '; path = xcode/' + basename + '; sourceTree = SDKS; };\n')
		elif self.type == 'cpp':
			fp.write('\t\t' + self.uuid + ' /* ' + basename + ' */ = {isa = PBXFileReference; fileEncoding = 4; lastKnownFileType = sourcecode.cpp.cpp; name = ' + basename + '; path = ' + self.filename + '; sourceTree = SOURCE_ROOT; };\n')
		else:
			fp.write('\t\t' + self.uuid + ' /* ' + basename + ' */ = {isa = PBXFileReference; fileEncoding = 4; lastKnownFileType = sourcecode.c.h; name = ' + basename + '; path = ' + self.filename + '; sourceTree = SOURCE_ROOT; };\n')
>>>>>>> 8cfb6bc... Updated makeprojects to auto-generate iOS projects under XCode 5.x. iOS binaries are "fat", meaning they have armv7, armv7s, arm64, i386 and x86_64 binaries so it works both on a native device and on the simulators
...
class PBXBuildFile:
	...
	def write(self,fp):
		basename = os.path.basename(self.filereference.filename)
		fp.write('\t\t' + self.uuid + ' /* ' + basename + ' in ' + self.type + ' */ = {isa = PBXBuildFile; fileRef = ' + self.filereference.uuid + ' /* ' + basename + ' */; };\n')
>>>>>>> 8cfb6bc... Updated makeprojects to auto-generate iOS projects under XCode 5.x. iOS binaries are "fat", meaning they have armv7, armv7s, arm64, i386 and x86_64 binaries so it works both on a native device and on the simulators
...
=======
		for item in self.buildlist:
			fp.write('\t\t\t\t' + item[0] + ' /* ' + item[1] + ' in Sources */,\n')
>>>>>>> 8cfb6bc... Updated makeprojects to auto-generate iOS projects under XCode 5.x. iOS binaries are "fat", meaning they have armv7, armv7s, arm64, i386 and x86_64 binaries so it works both on a native device and on the simulators
		fp.write('\t\t\t);\n')
	...
	def append(self,item):
<<<<<<< HEAD
		if (item.filereference.type=='glsl'):
...
=======
	def __init__(self,input,command,finalfolder):
		self.input = input
		self.command = command
		self.finalfolder = finalfolder
		self.uuid = calcuuid('PBXShellScriptBuildPhase' + str(input) + finalfolder + command)
>>>>>>> 8cfb6bc... Updated makeprojects to auto-generate iOS projects under XCode 5.x. iOS binaries are "fat", meaning they have armv7, armv7s, arm64, i386 and x86_64 binaries so it works both on a native device and on the simulators
...
=======
		fp.write('\t\t\t\t"' + self.finalfolder + '${FINAL_OUTPUT}",\n')
>>>>>>> 8cfb6bc... Updated makeprojects to auto-generate iOS projects under XCode 5.x. iOS binaries are "fat", meaning they have armv7, armv7s, arm64, i386 and x86_64 binaries so it works both on a native device and on the simulators
		fp.write('\t\t\t);\n')
		fp.write('\t\t\trunOnlyForDeploymentPostprocessing = 0;\n')
...
<<<<<<< HEAD
	def __init__(self,parent,name,productreference,productname,producttype):
		self.parent = parent
=======
	def __init__(self,name,productreference,productname,producttype):
>>>>>>> 8cfb6bc... Updated makeprojects to auto-generate iOS projects under XCode 5.x. iOS binaries are "fat", meaning they have armv7, armv7s, arm64, i386 and x86_64 binaries so it works both on a native device and on the simulators
		self.name = name
...
=======
	def __init__(self,projectname,idecode,platformcode,version):
		self.projectname = projectname
		self.idecode = idecode
		self.platformcode = platformcode
...
=======
		entry = PBXNativeTarget(name,productreference,productname,producttype)
>>>>>>> 8cfb6bc... Updated makeprojects to auto-generate iOS projects under XCode 5.x. iOS binaries are "fat", meaning they have armv7, armv7s, arm64, i386 and x86_64 binaries so it works both on a native device and on the simulators
...
=======
	def addshellscriptbuildphase(self,input,command,finalfolder):
		entry = PBXShellScriptBuildPhase(input,command,finalfolder)
>>>>>>> 8cfb6bc... Updated makeprojects to auto-generate iOS projects under XCode 5.x. iOS binaries are "fat", meaning they have armv7, armv7s, arm64, i386 and x86_64 binaries so it works both on a native device and on the simulators
...
=======
	def addxcbuildconfigurationlist(self,configname,configfilereference,owner,sdkroot):
		entry = XCBuildConfiguration(configname,configfilereference,owner,sdkroot)
>>>>>>> 8cfb6bc... Updated makeprojects to auto-generate iOS projects under XCode 5.x. iOS binaries are "fat", meaning they have armv7, armv7s, arm64, i386 and x86_64 binaries so it works both on a native device and on the simulators
