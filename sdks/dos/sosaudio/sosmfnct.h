...
W32 cdecl far sosDIGISendData      ( LPSTR, W32, W32 );
W32 cdecl far sosDIGIInit          ( LPSTR, W32, W32 );
W32 cdecl far sosDIGIUnInit        ( LPSTR, W32, W32 );
W32 cdecl far sosDIGIReset         ( LPSTR, W32, W32 );
W32 cdecl far sosDIGISetInstrumentData( LPSTR, W32, W32 );
VOID cdecl sosMIDIDIGISampleDoneCallback( PSOSSAMPLE );
...
HSOS digiQueueInit                     ( WORD );
VOID digiQueueUnInit                   ( HSOS );
WORD digiQueueAddItem                  ( HSOS, HSOS, WORD, WORD, WORD );
WORD digiQueueGetItem                  ( HSOS, WORD );
WORD digiQueueDeleteItemMIDI           ( WORD, WORD, WORD );
WORD digiQueueDeleteItem               ( HSOS, HSOS );
WORD digiQueueFindItemMIDI             ( HSOS, WORD, WORD );
WORD digiQueueGetItemWAVE              ( HSOS );
WORD digiQueueDeleteItemWAVE           ( HSOS, WORD );

DWORD sosMIDISetDigitalPatchFile       ( HSOS, PSTR );
DWORD sosMIDIFlushTriggeredPatches     ( HSOS, PTRACK );
DWORD sosMIDIReleaseDigitalPatchFile   ( HSOS );
DWORD sosMIDILoadTriggeredPatches      ( HSOS, PTRACK );
